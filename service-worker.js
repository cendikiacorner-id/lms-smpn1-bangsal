const CACHE_NAME = 'lms-bangsal-cloud-v20.2';
const APP_SHELL = [
  './', './index.html', './offline.html', './styles.css?v=20.2', './config.js',
  './app.js?v=20.2', './edmodo.js?v=20.2', './vendor/xlsx.full.min.js', './vendor/exceljs.min.js', './manifest.webmanifest',
