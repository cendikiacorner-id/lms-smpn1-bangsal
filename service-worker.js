const CACHE_NAME = 'lms-bangsal-cloud-v20.5';
const APP_SHELL = [
  './', './index.html', './offline.html', './styles.css?v=20.5', './config.js',
  './app.js?v=20.5', './edmodo.js?v=20.5', './vendor/xlsx.full.min.js', './vendor/exceljs.min.js', './manifest.webmanifest',
