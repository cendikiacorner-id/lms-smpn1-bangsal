const CACHE_NAME = 'lms-bangsal-cloud-v20.3';
const APP_SHELL = [
  './', './index.html', './offline.html', './styles.css?v=20.3', './config.js',
  './app.js?v=20.3', './edmodo.js?v=20.3', './vendor/xlsx.full.min.js', './vendor/exceljs.min.js', './manifest.webmanifest',
