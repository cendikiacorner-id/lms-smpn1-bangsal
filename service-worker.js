const CACHE_NAME = 'lms-bangsal-cloud-v13';
const APP_SHELL = [
  './', './index.html', './offline.html', './styles.css?v=13.0', './config.js',
  './app.js?v=13.0', './vendor/xlsx.full.min.js', './vendor/exceljs.min.js', './manifest.webmanifest',
