const CACHE_NAME = 'lms-bangsal-cloud-v12';
const APP_SHELL = [
  './', './index.html', './offline.html', './styles.css?v=12.0', './config.js',
  './app.js?v=12.0', './vendor/xlsx.full.min.js', './vendor/exceljs.min.js', './manifest.webmanifest',
