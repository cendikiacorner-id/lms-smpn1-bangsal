const CACHE_NAME = 'lms-bangsal-cloud-v14';
const APP_SHELL = [
  './', './index.html', './offline.html', './styles.css?v=14.0', './config.js',
  './app.js?v=14.0', './vendor/xlsx.full.min.js', './vendor/exceljs.min.js', './manifest.webmanifest',
