const CACHE_NAME = 'lms-bangsal-cloud-v20.1';
const APP_SHELL = [
  './', './index.html', './offline.html', './styles.css?v=20.1', './config.js',
  './app.js?v=20.1', './edmodo.js?v=20.1', './vendor/xlsx.full.min.js', './vendor/exceljs.min.js', './manifest.webmanifest',
